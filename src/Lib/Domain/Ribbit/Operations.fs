...
module Operations =
    ...
    let actionDeclarationTextP = TextProperty("ActionDeclarationText")
    let initiativeModifierP = NumberProperty("InitiativeModifier", 0)
    let currentInitiativeP = NumberProperty("CurrentInitiative")
