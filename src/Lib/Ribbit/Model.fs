...
module Model =
    ...
    module Ribbit =
        ...
        type Address =
            ...
            with
            member this.mapRow newRowId =
                match this with
                | EventProperty(_, prop) -> EventProperty(EventId newRowId, prop)
                | CreatureProperty(_, prop) -> CreatureProperty(CreatureId newRowId, prop)
            member this.mapProperty newPropName =
                match this with
